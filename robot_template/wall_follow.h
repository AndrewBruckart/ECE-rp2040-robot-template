...
enum WallFollowState {
  ...
  WALL_FOLLOW_STATE_TUNNEL_TURN,
  WALL_FOLLOW_STATE_TUNNEL_FIND_WALL,
  WALL_FOLLOW_STATE_TUNNEL_FOLLOW,
  WALL_FOLLOW_STATE_TUNNEL_STRAIGHT,
  WALL_FOLLOW_STATE_AFTER_TUNNEL_EXIT_TURN,
  WALL_FOLLOW_STATE_AFTER_TUNNEL_STRAIGHT,
  WALL_FOLLOW_STATE_AFTER_TUNNEL_APPROACH,
  WALL_FOLLOW_STATE_AFTER_TUNNEL_FOLLOW,
  WALL_FOLLOW_STATE_AFTER_TUNNEL_FWD_PAST_GAP,
  WALL_FOLLOW_STATE_AFTER_TUNNEL_BACK,
  WALL_FOLLOW_STATE_AFTER_TUNNEL_FIRST_PAUSE,
  WALL_FOLLOW_STATE_AFTER_TUNNEL_CLOSE_LEFT,
  WALL_FOLLOW_STATE_AFTER_TUNNEL_FINAL_LEFT,
  WALL_FOLLOW_STATE_AFTER_TUNNEL_CHARGE_STOP,
  WALL_FOLLOW_STATE_AFTER_TUNNEL_WF2
};
